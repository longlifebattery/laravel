...
Route::filter('age', function($route, $reqeust, $age)
{
    if ( (int) $age < 18) return "Soon.. but not yet.";
});

// Own solution challange 2
//Route::filter('birthday', function($route, $reqeust, $bday)
//{
//    if (date('m/d/y') == $bday) {
...
// Lavavel dude solution
Route::filter('birthdate', function($route, $reqeust, $birthdate)
{
